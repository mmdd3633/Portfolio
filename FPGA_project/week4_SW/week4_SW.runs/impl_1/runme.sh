...
HD_PWD='C:/Tukorea/FPGA_project/week4_SW/week4_SW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week4_SW16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week4_SW16.tcl -notrace
