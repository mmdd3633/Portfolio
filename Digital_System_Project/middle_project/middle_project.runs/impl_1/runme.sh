...
HD_PWD='C:/Tukorea/Digital_System_Project/middle_project/middle_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log middle_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source middle_project_wrapper.tcl -notrace
