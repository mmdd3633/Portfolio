...
HD_PWD='C:/Tukorea/Digital_System_Project/week11/week11.runs/week11_axi_apb_bridge_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week11_axi_apb_bridge_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week11_axi_apb_bridge_0_2.tcl
