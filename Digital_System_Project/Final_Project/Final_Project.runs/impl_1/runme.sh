...
HD_PWD='C:/Tukorea/Digital_System_Project/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_Project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Final_Project_wrapper.tcl -notrace
