...
HD_PWD='C:/Tukorea/FPGA_project/week11/week11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week11.tcl
