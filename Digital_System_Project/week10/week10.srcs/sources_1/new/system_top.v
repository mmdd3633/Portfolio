...
// Target Devices: 
// Tool Versions: 
// Description: Zynq PS and Expanded APB Slave (LED & Switch) Top Module
// 
// Dependencies: 
// 
// Revision:
// Revision 0.01 - File Created
// Additional Comments: Expanded for Color LEDs and Switch Inputs
// 
//////////////////////////////////////////////////////////////////////////////////
...
module system_top (
    ...
    // ==========================================
    // 사용자 정의 외부 포트 (Board LED & Switch)
    // ==========================================
    output wire [9:0]  o_led,         // 단색 LED 10개
    output wire [2:0]  o_color_led_0, // 컬러 LED 0 (RGB)
    output wire [2:0]  o_color_led_1, // 컬러 LED 1 (RGB)
    input  wire [11:0] i_sw           // 슬라이드 스위치 12개 입력
);
    ...
    // ==========================================
    week10_wrapper u_week10_wrapper (
        // APB Bus Connection
    ...
    // ==========================================
    // 2. 확장된 Custom APB Slave (LED & SW Controller) 인스턴스화
    // ==========================================
    apb_led u_apb_led (
        // 클럭 및 리셋
        .i_clk         (w_apb_clk),
        .i_rst_n       (w_apb_rst[0]),   // [객관적 오류 수정]: Active-High 리셋을 Active-Low로 반전
        
        // APB 버스 인터페이스
        .i_apb_paddr   (w_apb_paddr),
        .i_apb_penable (w_apb_penable),
        .i_apb_psel    (w_apb_psel[0]),   
        .i_apb_pwrite  (w_apb_pwrite),
        .i_apb_pwdata  (w_apb_pwdata),
        .o_apb_prdata  (w_apb_prdata),
        .o_apb_pready  (w_apb_pready[0]), 
        .o_apb_pslverr (w_apb_pslverr[0]),
        
        // 확장된 사용자 외부 포트 연결
        .o_led         (o_led),           // 단색 LED 포트 연결
        .o_color_led_0 (o_color_led_0),   // 컬러 LED 0 포트 연결
        .o_color_led_1 (o_color_led_1),   // 컬러 LED 1 포트 연결
        .i_sw          (i_sw)             // 스위치 입력 포트 연결
    );
