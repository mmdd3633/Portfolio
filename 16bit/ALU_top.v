...
module ALU_top (
    ...
    alu_arithmetic u_arith (
        ...
        .cin(cin),
        .alu_result0(result_lo_arith),
        .alu_result1(result_hi_arith),
        .alu_flag(flag_arith)
    );
