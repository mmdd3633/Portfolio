...
HD_PWD='C:/Tukorea/FPGA_project/2021142001_FPGA_Exam1/2021142001_FPGA_Exam1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Exam1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Exam1.tcl -notrace
