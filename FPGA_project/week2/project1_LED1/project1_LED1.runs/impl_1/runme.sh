...
HD_PWD='C:/Tukorea/FPGA_project/week2/project1_LED1/project1_LED1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED1.tcl -notrace
