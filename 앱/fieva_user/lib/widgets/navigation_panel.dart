...
class NavigationPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hasRoute = currentStep != null;
    final turn = currentStep?.turn ?? TurnDirection.straight;
    final arrived = hasRoute && turn == TurnDirection.arrive;
    final bg = arrived
        ? const Color(0xFF16A34A)
        : fireActive
        ? const Color(0xFFE11D48)
        : const Color(0xFF172033);
    final accent = arrived
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            if (fireActive && !arrived) _fireBanner(),
            Row(
            ...
            Container(
              ...
              child: hasRoute
                  ? Icon(_arrowIcon(turn), color: Colors.white, size: 104)
