...
HD_PWD='C:/Tukorea/Digital_System_Project/week2/week2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_sys_wrapper.tcl -notrace
