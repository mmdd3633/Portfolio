...
HD_PWD='C:/Tukorea/Digital_System_Project/week9/week8.runs/week9_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week9_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week9_processing_system7_0_0.tcl
