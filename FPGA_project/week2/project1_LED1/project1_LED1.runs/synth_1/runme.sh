...
HD_PWD='C:/Tukorea/FPGA_project/week2/project1_LED1/project1_LED1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED1.tcl
