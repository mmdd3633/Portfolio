...
HD_PWD='C:/Tukorea/FPGA_project/week7/week7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week7.tcl
