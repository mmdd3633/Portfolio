...
HD_PWD='C:/Tukorea/Digital_System_Project/middle_project/middle_project.runs/middle_project_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log middle_project_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source middle_project_rst_ps7_0_100M_0.tcl
