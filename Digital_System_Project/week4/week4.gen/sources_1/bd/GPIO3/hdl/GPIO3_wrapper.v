...
//Command     : generate_target GPIO3_wrapper.bd
//Design      : GPIO3_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module GPIO3_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  GPIO3 GPIO3_i
       (.DDR_addr(DDR_addr),
        ...
        .sws_12bits_tri_i(sws_12bits_tri_i));
