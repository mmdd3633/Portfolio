...
HD_PWD='C:/Tukorea/FPGA_project/2021142001_FPGA_Exam1/2021142001_FPGA_Exam1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exam1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exam1.tcl
