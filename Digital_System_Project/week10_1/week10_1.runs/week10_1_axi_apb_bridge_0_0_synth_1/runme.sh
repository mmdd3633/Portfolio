...
HD_PWD='C:/Tukorea/Digital_System_Project/week10_1/week10_1.runs/week10_1_axi_apb_bridge_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week10_1_axi_apb_bridge_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week10_1_axi_apb_bridge_0_0.tcl
