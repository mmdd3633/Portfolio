...
HD_PWD='C:/Tukorea/FPGA_project/week4_SW/week4_SW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week4_SW16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week4_SW16.tcl
