...
HD_PWD='C:/Tukorea/Digital_System_Project/week2/week2.runs/zynq_sys_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_sys_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_sys_processing_system7_0_0.tcl
