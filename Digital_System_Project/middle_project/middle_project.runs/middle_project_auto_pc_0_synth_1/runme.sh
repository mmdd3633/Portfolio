...
HD_PWD='C:/Tukorea/Digital_System_Project/middle_project/middle_project.runs/middle_project_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log middle_project_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source middle_project_auto_pc_0.tcl
