...
HD_PWD='C:/Tukorea/FPGA_project/week8/week8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week8.tcl
