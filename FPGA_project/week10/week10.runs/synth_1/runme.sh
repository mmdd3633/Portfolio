...
HD_PWD='C:/Tukorea/FPGA_project/week10/week10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week10.tcl
