...
class _OverlayPainter extends CustomPainter {
  ...
  void _drawUser(
    ...
    canvas.drawCircle(p, 38, Paint()..color = const Color(0x5524C8FF));
    canvas.drawCircle(p, 24, Paint()..color = const Color(0xFF0EA5E9));
    canvas.drawCircle(
      p,
      24,
      Paint()
    ...
    _drawLabel(
      canvas,
      p.translate(0, -38),
      user.userId?.isNotEmpty == true ? user.userId! : '현재 위치',
      background: const Color(0xFF0369A1),
    );
  }
