...
HD_PWD='C:/Tukorea/Digital_System_Project/week10/week10.runs/week10_axi_apb_bridge_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week10_axi_apb_bridge_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week10_axi_apb_bridge_0_1.tcl
