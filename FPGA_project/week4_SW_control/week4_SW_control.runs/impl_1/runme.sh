...
HD_PWD='C:/Tukorea/FPGA_project/week4_SW_control/week4_SW_control.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week4_SW1_control.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week4_SW1_control.tcl -notrace
