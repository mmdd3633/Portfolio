...
HD_PWD='C:/Tukorea/FPGA_project/week4_SW_control/week4_SW_control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week4_SW1_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week4_SW1_control.tcl
