...
HD_PWD='C:/Tukorea/Digital_System_Project/week3/week3.runs/PS_Block_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_Block_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_Block_axi_gpio_1_0.tcl
