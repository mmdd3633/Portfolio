...
HD_PWD='C:/Tukorea/Digital_System_Project/week4/week4.runs/GPIO3_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO3_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPIO3_axi_gpio_1_0.tcl
