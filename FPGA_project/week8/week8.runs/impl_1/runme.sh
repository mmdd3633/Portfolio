...
HD_PWD='C:/Tukorea/FPGA_project/week8/week8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week8.tcl -notrace
