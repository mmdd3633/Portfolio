...
HD_PWD='C:/Tukorea/Digital_System_Project/week5/week5.runs/week5_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week5_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week5_axi_gpio_0_0.tcl
