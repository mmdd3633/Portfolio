...
//Command     : generate_target Final_Project_wrapper.bd
//Design      : Final_Project_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module Final_Project_wrapper
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  Final_Project Final_Project_i
       (.DDR_addr(DDR_addr),
        ...
        .GYRO_CS_AG_0(GYRO_CS_AG_0),
        .GYRO_CS_M_0(GYRO_CS_M_0),
        .GYRO_DEN_AG_0(GYRO_DEN_AG_0),
        .GYRO_SDO_AG_0(GYRO_SDO_AG_0),
        .GYRO_SDO_M_0(GYRO_SDO_M_0),
