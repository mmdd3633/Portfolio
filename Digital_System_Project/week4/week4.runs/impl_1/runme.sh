...
HD_PWD='C:/Tukorea/Digital_System_Project/week4/week4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GPIO3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GPIO3_wrapper.tcl -notrace
