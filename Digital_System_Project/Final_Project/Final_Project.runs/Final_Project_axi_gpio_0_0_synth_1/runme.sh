...
HD_PWD='C:/Tukorea/Digital_System_Project/Final_Project/Final_Project.runs/Final_Project_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Final_Project_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Final_Project_axi_gpio_0_0.tcl
