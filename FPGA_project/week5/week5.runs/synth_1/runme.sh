...
HD_PWD='C:/Tukorea/FPGA_project/week5/week5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log week5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source week5.tcl
