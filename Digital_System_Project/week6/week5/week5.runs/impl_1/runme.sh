...
HD_PWD='C:/Tukorea/Digital_System_Project/week5/week5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log week5_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source week5_wrapper.tcl -notrace
